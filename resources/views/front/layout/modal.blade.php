        ...
        <div class="modal-content border-0 rounded-0">
            <div class="modal-header bg-light px-5 pt-0 pb-5">
                <div class="ts-title mb-0">
                    <figure class="ts-circle__md bg-dark rounded-0"><img src="/images/pic/olr/icon-brushes.png" alt=""></figure>
                ...
                <div class="owl-carousel" data-owl-dots="1">
                    <div class="slide">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-4"><img src="/images/pic/olr/img-work-detail-01.jpg" alt=""></div>
                    ...
                    <div class="slide">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-4"><img src="/images/pic/olr/img-work-detail-02.jpg" alt=""></div>
                                <div class="col-md-8">
