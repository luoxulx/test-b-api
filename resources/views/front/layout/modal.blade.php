        ...
        <div class="modal-content border-0 rounded-0">
            <div class="modal-header bg-light px-5 pt-0 pb-5">
                <div class="ts-title mb-0">
                    <figure class="ts-circle__md bg-dark rounded-0"><img src="https://net.lnmpa.top/owl/pic/icon-brushes.png" alt="icon-brushes"></figure>
                    <h4 class="mb-0">Web Design2222</h4>
                </div>
                ...
                <div class="owl-carousel" data-owl-dots="1">
                    <div class="slide">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-4"><img src="https://net.lnmpa.top/owl/pic/img-work-detail-01.jpg" alt="img-work-detail"></div>
                    ...
                    <div class="slide">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-4"><img src="https://net.lnmpa.top/owl/pic/img-work-detail-02.jpg" alt="img-work-detail-02"></div>
                                <div class="col-md-8">
